...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,
            btn_7,btn_8,btn_9,btn_clear,btn_factorial,btn_percent,
            btn_del,btn_leftbra,btn_rightbra,btn_PandM,
            btn_squ2,btn_sin,btn_cos,btn_div,btn_mul,
            btn_sub,btn_add,btn_equ,btn_p,btn_2squ,btn_3squ;
    EditText text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_2squ = (Button) findViewById(R.id.btn_2squ);
        btn_2squ.setOnClickListener(this);

        btn_3squ = (Button) findViewById(R.id.btn_3squ);
        btn_3squ.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.btn_factorial:
               if(str.charAt(0)=='-'){
                   Toast.makeText(MainActivity.this,"Negative numbers cannot be factorized!",Toast.LENGTH_SHORT).show();
                   text.setText("0");
               }
               else {
                   double fac=Double.parseDouble(str);
                   if((int)fac==fac){
                       int fact=1;
                       for(int i=1;i<=fac;i++){
                           fact=fact*i;
                       ...
                       Toast.makeText(MainActivity.this,"Decimals cannot be factorized!",Toast.LENGTH_SHORT).show();
                       text.setText("0");
                   }
               }
                break;
            ...
            case R.id.btn_PandM:
                ...
                break;
            case R.id.btn_2squ:
                double s2 = Double.parseDouble(str);
                s2 = s2 * s2;
                String str2=""+s2;
                text.setText(str2);
                break;
